...
<div class="col-12 mb-0">
            ...
            <header class="header row align-items-center">
                ...
                <div class="col">
                <div class="cq_oth_page_top_hdng">Mining</div>
                </div>
                <div class="col-auto">
    ...
    aria-selected="false">USDT (TRC20)</button>
    </li> -->
    ...
    <form class="" id="myForm"  method="post" action="<?php echo base_url();?>users/miningverify" 
...
<span class="text-danger mt-3"> Maintain a sufficient BNB balance and avoid transaction failures  </span>
    ...
    <button id="myButton" type="submit" class="cq_comn_btn w-100 mt-4 mb-5">Apply Mining</button>
    ...
    <div class="tab-pane fade" id="pills-busd" role="tabpanel" aria-labelledby="pills-eth-tab" tabindex="0">
    <div class="srk srk_fs_1 srk_fw_500 srk_clr_black_1 srk_mb_1">Investment Volume</div>

    <form class="" id="myForm_3"  method="post" action="<?php echo base_url();?>users/miningverify" 
    data-parsley-validate="true">
   ...
   <option value="">-- select date --</option>
    ...
    <div class="srk srk_fs_0dot8 srk_fw_600 srk_clr_black_06">
    Daily Yield: <span class="srk_clr_black_1">
    <?php echo $mining_config->le_interest + $mining_config->staking_interest; ?> %</span>
    </div>
    </div>
...
<span class="text-danger mt-3"> Maintain a sufficient BNB balance and avoid transaction failures  </span>
    ...
    <button id="myButton3" type="submit" class="cq_comn_btn w-100 mt-4 mb-5">Apply Mining</button>
    ...
    aria-labelledby="pills-eth-tab" tabindex="0">
    <div class="srk srk_fs_1 srk_fw_500 srk_clr_black_1 srk_mb_1">Investment Volume</div>

    <form class="" id="myForm_2"  method="post" action="<?php echo base_url();?>users/miningverify" 
    data-parsley-validate="true">
   ...
   <option value="">-- select date --</option>
    ...
    <div class="srk srk_fs_0dot8 srk_fw_600 srk_clr_black_06 ">
    Balance : <span class="srk_clr_black_1">
    <span class="srk_clr_black_1 " id="balance_info_trx">
    </span>
    </div>
    </div>
    <div class="col-6 text-end">
    ...
    <div class="srk srk_fs_0dot8 srk_fw_600 srk_clr_black_06">
    Daily Bonus: <span class="srk_clr_black_1">
    <?php echo  $mining_config->staking_interest; ?> %</span>
    </div>
    ...
    <button id="myButton2" type="submit" class="cq_comn_btn w-100 mt-4 mb-5">Apply Mining</button>
    ...
    $commission_info = $this->db->query("SELECT * FROM lending_settings where id = '2' ")->row();
    ...
    <span class="cq_badge clr_light_3 srk_fw_700"><?php echo $interest_get; ?> %</span>
    </div>
    </div>
    <hr>
    ...
    <div class="srk srk_fs_0dot8 srk_fw_600 srk_clr_black_06 cq_report_card_li">
    Mining on: <span class="srk_clr_black_1 text-success"><?php echo $start_date; ?></span>
    </div>
    ...
    <div class="srk srk_fs_0dot8 srk_fw_600 srk_clr_black_06 cq_report_card_li">
    Mining End: <span class="srk_clr_black_1 text-danger"><?php echo $end_date; ?></span>
    </div>
...
<!-- /*****************************  INCLUDE WEB 3 SCRIPT FOLDER *************************/ -->
    ...
    $('#error_info2').html('Please enter a valid amount (2000, 4000, 6000, or a multiple of 2000).');
    $('#myButton2').prop('disabled', true);     
    ...
    $('#error_info3').html('Please enter a valid amount (2000, 4000, 6000, or a multiple of 2000).');
    $('#myButton3').prop('disabled', true);     
